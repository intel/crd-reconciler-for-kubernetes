...
import (
	v1beta1 "github.com/NervanaSystems/kube-controllers-go/cmd/example-controller/pkg/apis/apiextensions/v1beta1"
	scheme "github.com/NervanaSystems/kube-controllers-go/cmd/example-controller/pkg/client/clientset/clientset/scheme"
