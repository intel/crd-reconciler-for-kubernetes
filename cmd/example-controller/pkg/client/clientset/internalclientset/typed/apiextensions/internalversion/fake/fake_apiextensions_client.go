...
import (
	internalversion "github.com/NervanaSystems/kube-controllers-go/cmd/example-controller/pkg/client/clientset/internalclientset/typed/apiextensions/internalversion"
