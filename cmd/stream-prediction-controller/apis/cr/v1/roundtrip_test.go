...
func TestRoundTrip(t *testing.T) {
	...
	roundtrip.RoundTripSpecificKindWithoutProtobuf(t, SchemeGroupVersion.WithKind("StreamPrediction"), scheme, codecs, fuzzer, nil)
	roundtrip.RoundTripSpecificKindWithoutProtobuf(t, SchemeGroupVersion.WithKind("StreamPredictionList"), scheme, codecs, fuzzer, nil)
}
