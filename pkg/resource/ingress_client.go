...
func (c *ingressClient) Update(namespace string, name string, templateValues interface{}) error {
	resourceBody, err := c.Reify(templateValues)
	if err != nil {
		return err
	}
...
func (c *ingressClient) Patch(namespace string, name string, data []byte) error {
